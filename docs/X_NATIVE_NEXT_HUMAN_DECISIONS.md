# X Native Next Human Decisions

The next milestones require product, authority, or security decisions from Otis.
...
These should stay automated by X Native work:
